...
class CfgImagesRestController(object):
    ...
    def get_engine_rest_cfgimages_helper(self, ):
        ...
        # The parameters of get_engine_rest_cfgimages_helper
        parameters = {
        }

        # The request payload of get_engine_rest_cfgimages_helper
        payload = {
        }
        ...
        response = self.requests_utility.get('ENGINE/rest/cfgimages', payload=payload, headers=headers,
                                             params=parameters)
