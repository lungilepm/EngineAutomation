...
class CfgQueryRestController(object):
    ...
    def get_engine_rest_cfgquery_findallforagencyid_helper(self, agencyId=None):
        ...
        # The parameters of get_engine_rest_cfgquery_findallforagencyid_helper
        parameters = {
            'agencyId': agencyId}

        # The request payload of get_engine_rest_cfgquery_findallforagencyid_helper
        payload = {
        }
        ...
        response = self.requests_utility.get('ENGINE/rest/cfgQuery/findAllForAgencyId', payload=payload,
